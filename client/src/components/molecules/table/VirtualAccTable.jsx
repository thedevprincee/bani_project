        ...
        <TBody>
          {bankDetails.map((bank) => (
            <TRow key={bank.id}>
              <TData>
                <TDataContent>
                  <Image src={bank.logo} width="30px" />
                  <Text>{bank.name}</Text>
                </TDataContent>
              </TData>
              <TData>
