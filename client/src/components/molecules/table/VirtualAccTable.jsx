  ...
  return (
   <TableWrapper>
    <Table>
        ...
        <TBody>
            {
            [1,2,3,4].filter((n)=>(n != searchValue)).map(bank=>(
                <TRow key={bank}>
                <TData>
                    <TDataContent>
                	  <Image src={banklogo} width="30px" />
                      <Text>{bank} Polaris Bank Limited</Text>		
                    </TDataContent>
                </TData>
                <TData>
                    <TDataContent>
                        
                       <Text>08023221144</Text>
                       <MdContentCopy />		
                       <Badge icon={<GiContract />} color="blue" bgcolor="skyblue" title="Dodo - Ikeja" />                    </TDataContent>
                </TData>
                <TData>
                    <TDataContent>
                       <Text>NGN 100,000.00</Text>
                       <HiDotsVertical />		
                    </TDataContent>
                </TData>
            </TRow>
